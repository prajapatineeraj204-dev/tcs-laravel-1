            ...
            <div class="col-md-4 col-lg-4">
                <div class="card__image card__box-v1">
                    ...
                    <div class="card__image-footer">
                        <div>
                            <a href="{{$mentor->linkedin_profile}}" target="_blank" class="btn btn-primary btn__left"> <i class="fab fa-linkedin-in"></i> LinkedIn </a>
                            
                             <a href="appointment_booking/{{$mentor->id}}" class="btn whatsApp-button btn__rigth"> <i class="far fa-calendar-check"></i> Book Now </a>
                        </div>
