            ...
            <div class="card">
                <ul class="d-flex justify-content-around nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item w-50" role="presentation">
                        <button class="nav-link active w-100 m-auto" id="catlist-tab" data-bs-toggle="tab"
                            data-bs-target="#catlist" type="button" role="tab" aria-controls="catlist"
                            aria-selected="true"> Product List</button>
                    </li>
                    <li class="nav-item w-50" role="presentation">
                        <button class="nav-link w-100 m-auto" id="cat-tab" data-bs-toggle="tab" data-bs-target="#cat"
                            type="button" role="tab" aria-controls="cat" aria-selected="false">Add Product</button>
                    </li>
                </ul>
                                    ...
                                    @if (isset($productlist))
                                        @foreach ($productlist as $list)
                                            <tr>
                                                ...
                                                <td><img src="{{ asset('productimg/' . $list->product_img) }}"
                                                ...
                                                <td>
                                                    <a href="" class="me-2 btn btn-primary btn-sm"><i
                                                            class="fas fa-eye"></i>
                                                    </a>

                                                    <a href="{{ route('product.edit', base64_encode($list->id)) }}"
                                                        class="btn btn-info btn-sm"><i class="fas fa-edit"></i>
                                                    </a>
                                                    <a class="btn btn-danger me-2 btn-sm" href="javascript:void(0)"
                                                        onclick="event.preventDefault();document.getElementById('destroy-form').submit();"><i
                                                            class="fas fa-trash"></i></a>

                                                    <form id="destroy-form"
                                                        action="{{ route('product.destroy', base64_encode($list->id)) }}"
                        ...
                        <div class="tab-pane fade" id="cat" role="tabpanel" aria-labelledby="cat-tab">
                            <form action="{{ route('product.store') }}" method="post" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input name="product_name" type="text" class="form-control"
                                                id="validationCustom01" placeholder="Product name" required="">
                                            @error('product_name')
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            <label class="form-label" for="validationCustom02">Regular Price (Rs.)
                                                *</label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="saleprice" required class="form-control"
                                                id="saleprice">
                                            @error('saleprice')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <div class="w-100 d-flex file-drop-area flex-column justify-content-center">
                                                <span class="choose-file-button">The higher the resolution, the better your
                                                    upload will look on your gear.</span>
                                                <span class="file-message">Drag and drop <span
                                                        style="color: blue;">Browse</span> Your Computer</span>
